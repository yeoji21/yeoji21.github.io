...
1번
```r
> gapminder%>%filter(country=="Korea, Rep."|country=="Japan"|country=="China")
                %>%select(country, gdpPercap, lifeExp, year)
# A tibble: 36 × 4
   country gdpPercap lifeExp  year
   <fct>       <dbl>   <dbl> <int>
 1 China        400.    44    1952
 2 China        576.    50.5  1957
 3 China        488.    44.5  1962
 4 China        613.    58.4  1967
 5 China        677.    63.1  1972
 6 China        741.    64.0  1977
 7 China        962.    65.5  1982
 8 China       1379.    67.3  1987
 9 China       1656.    68.7  1992
10 China       2289.    70.4  1997
# … with 26 more rows
```
...
3번
```r
> group_by(gapminder_unfiltered,country)%>%summarise(count=n())%>%filter(count>=12)%>%arrange(desc(count))
# A tibble: 149 × 2
   country         count
   <fct>           <int>
 1 Czech Republic     58
