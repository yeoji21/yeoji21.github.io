...
4줄 나열 프로그램
```r
> newStu = data.frame(gre=c(400), gpa=c(3.5), rank=c(1))
> predict(m, newdata=newStu, type='response')
        1 
0.4079495 
> newStu = data.frame(gre=c(400), gpa=c(3.5), rank=c(2))
> predict(m, newdata=newStu, type='response')
        1 
0.2824219 
> newStu = data.frame(gre=c(400), gpa=c(3.5), rank=c(3))
> predict(m, newdata=newStu, type='response')
        1 
0.1835451 
> newStu = data.frame(gre=c(400), gpa=c(3.5), rank=c(4))
> predict(m, newdata=newStu, type='response')
        1 
0.1137957 
```
...
```r
> for (i in 1:4){
+     newStu = data.frame(gre=c(400), gpa=c(3.5), rank=c(i))
+     print(predict(m, newdata=newStu, type='response'))
+ }
        1 
0.4079495 
        1 
